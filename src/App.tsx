...
const ProjectsPortfolio: React.FC = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Специализированная нейросеть-помощник @tokkipugpt_bot, обученная консультировать в строгом медицинском стиле. Бот выступает в роли виртуального медицинского ассистента, способного выслушать симптомы, дать общие рекомендации и направить пользователя. Проект построен на современных генеративных моделях с использованием сложного промпт-инжиниринга для строгого соблюдения медицинской этики.",
      features: [
        "Специализированный медицинский tone of voice и системный промпт",
        "Умное поддержание контекста длинных диалогов с пользователями",
        "Удобный интерфейс классического Telegram-бота",
        "Open-source реализация"
      ],
      link: "https://github.com/angerrissuess/bunny-bott"
    }
  ];
